...
export const AboutSection: React.FC<AboutSectionProps> = ({ onOpenProjectInquiry }) => {
  ...
  return (
    <section id="about-section" className="py-20 md:py-28 bg-slate-50 relative text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {engineeringStandards.map((std, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white rounded-2xl p-7 border border-slate-200 shadow-2xs flex flex-col justify-between"
              >
                <div>
                  <div className="w-11 h-11 rounded-xl bg-slate-900 text-cyan-400 flex items-center justify-center mb-4">
                ...
                <div className="pt-4 border-t border-slate-100 mt-4 flex items-center gap-1 text-[11px] font-mono text-emerald-700">
        ...
        <div className="p-7 sm:p-9 rounded-2xl bg-white border border-slate-200 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
          ...
          <button
            ...
            className="px-6 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs font-mono transition-all shrink-0 flex items-center gap-2"
          >
