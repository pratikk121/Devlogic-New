      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 tracking-tight leading-[1.12]">
            Custom Software & Digital Systems <span className="text-cyan-700">Engineered for Impact.</span>
          </h1>
          ...
          <div className="mt-8 flex items-center justify-center flex-wrap gap-x-6 gap-y-2 text-xs font-semibold text-slate-600 tracking-wide">
